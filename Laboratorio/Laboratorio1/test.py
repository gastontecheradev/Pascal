...
if "compiled" not in output:
    ...
    for p in sorted(casos):
        ...
        try:
            ...
            if salida == output:
                print (" -- El caso", p," se resolvió correctamente\n")
                correctos += 1
            else:
                print("**********************************")
                print(" -- El caso", p, " tiene errores.")
                print(f"Analizar el archivo diffs/{p}")
                # print("La entrada es: ")
                # print(entrada)
            ...
            print("**********************************")
            print(" -- El caso", p, " produjo un error en tiempo de ejecución.")
            traceback.print_exc()
            print("**********************************\n")
            erroneos += 1
